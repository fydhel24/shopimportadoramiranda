...
const Categorias: React.FC = () => {
  ...
  if (loading) return <div className="text-center py-10 text-purple-600">Cargando categorías...</div>
  if (error) return <div className="text-center py-10 text-red-500">{error}</div>

  return (
    <section className=" relative min-h-screen bg-gradient-to-b from-purple-100 to-white">

      <div className="container mx-auto text-center mb-8 relative z-10">
        {/* Buscador estático */}

        {/* Buscador fijo */}
        <section className="py-10 mt-20 relative min-h-screen bg-gradient-to-b from-purple-100 to-white">
  {/* Sección estática con título */}
  <div className="container mx-auto text-center mb-8 relative z-10">
    <h2 className="text-4xl font-bold text-purple-800">Categorías</h2>
  ...
  <div className="container mx-auto px-4 mt-12">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {filteredCategories.map((category) => (
        <div
          key={category.id}
          className="bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer transform hover:scale-105 transition-all duration-300 border-2 border-purple-500"
        ...
        >
          <div className="p-6">
            ...
            <div className="mt-6 text-center">
              <span className="text-purple-600 hover:text-purple-700 font-medium">Ver Colección</span>
            </div>
          </div>
        </div>
      ))}
